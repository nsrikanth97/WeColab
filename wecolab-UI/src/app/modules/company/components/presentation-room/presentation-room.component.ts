...
import {PresentationroomService} from '../../../employee/services/presentationroom.service'; 
import { ToastrService } from 'ngx-toastr';

@Component({
  selector: 'app-presentation-room',
  templateUrl: './presentation-room.component.html',
  styleUrls: ['./presentation-room.component.css']
})
export class PresentationRoomComponent implements OnInit {
  ...
  constructor(private service: PresentationroomService, private toaster:ToastrService) { }
  ...
  ngOnInit() {
    ...
    // console.log("ayush",this.currentUserInfo);
